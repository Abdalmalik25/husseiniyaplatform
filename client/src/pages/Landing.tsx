        ...
        <div className="relative max-w-7xl mx-auto px-4 py-14 lg:py-20">
          <div className="max-w-3xl space-y-5">
            <Badge className="bg-white/10 text-white border-white/20">
              مؤسسة الحسينية لخدمات الأعمال — منذ 2018
            </Badge>
            <h1 className="text-3xl lg:text-5xl font-black leading-tight text-balance">
              شريك نموك{" "}
              <span className="text-brand-300">من الفكرة إلى الأثر</span>
            </h1>
            <p className="text-base lg:text-lg text-white/70 leading-relaxed">
              نحن شركة خدمات أعمال متكاملة. نخدم{" "}
              <strong className="text-white">
                المقاول وصاحب الأرض، التاجر وصاحب المتجر، الطالب والباحث
              </strong>{" "}
              — بحلول واضحة: استشارات مؤسسية، هندسية، ومعرفية. ومن منتجاتنا
              الرقمية منصة <strong className="text-brand-300">Uamex ERP</strong>{" "}
              لإدارة المحاسبة والتجارة والمخزون.
            </p>
            <div className="flex flex-wrap gap-3">
              ...
              <Button
                ...
                className="h-11 px-7 bg-white/5 border-white/20 text-white hover:bg-white/10"
              >
                دخول النظام
              </Button>
              <Button
                variant="outline"
                onClick={() => setLocation("/login")}
                className="h-11 px-7 bg-transparent border-white/20 text-white/80 hover:text-white"
              >
                سجل منشأتك
              </Button>
            </div>
            <p className="text-xs text-white/50">
              شركة: الحسينية لخدمات الأعمال — منتج رقمي: Uamex ERP (أحد حلولنا)
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 py-12">
        <div className="max-w-3xl mx-auto text-center space-y-3">
          ...
          <h2 className="text-2xl lg:text-3xl font-black">
            شركة تضع القرار أمامك — لا التوقع
          </h2>
          <p className="text-sm text-slate-600 leading-relaxed">
            نبني هياكل واضحة، ودلائل إجراءات، وأرقاما قابلة للمراجعة. هدفنا قرار
            يبنى على بيان، لا على انطباع.
          </p>
        </div>
      ...
      >
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto space-y-2">
            ...
            <h2 className="text-2xl lg:text-3xl font-black">
              ثلاثة مسارات — حل واحد متكامل
            </h2>
            <p className="text-sm text-slate-600">
              اختر مسارك — نحن نربط الباقي ببعضه.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-4 mt-8">
        ...
        <div className="rounded-3xl bg-slate-900 text-white p-8 lg:p-10 flex flex-col lg:flex-row gap-8 items-center">
          <div className="flex-1 space-y-3">
            <Badge className="bg-white/10 text-brand-300 border-white/20">
              منتج رقمي من الحسينية — Uamex ERP
            </Badge>
            <h2 className="text-2xl lg:text-3xl font-black">
              منصة تشغيل — لا مجرد برنامج محاسبة
            </h2>
            <p className="text-sm text-white/70 leading-relaxed">
              Uamex ERP هو أحد منتجاتنا الرقمية لإدارة المحاسبة والمبيعات
              والمخزون والموارد. يعمل بمعايير محاسبية واضحة، مع صلاحيات محكمة
              وسجل تدقيق.
            </p>
